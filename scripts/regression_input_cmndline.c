...
void cofact(double[100][100], double, double[100], int, double, double[100][100], double[100]);
void trans(double[100][100], double[100][100], double, double[100], int, double, double[100][100], double[100]);
double reg(double, double[100], int, double[100][100], double, double[100][100], double[100]);
...
//	printf("Enter the variables\n");
	...
	{	
		for (rows = 1; rows <= SF_nobs(); rows++)
		{
			...
			SF_mat_store(argv[0], rows, cols, x[cols][rows]);
		}
	}
	...
	else
	{
		...
		for (rows = 1; rows <= SF_nobs(); rows++)
		{
			...
			y[rows] = z;
			SF_mat_store(argv[1], rows, SF_nvars(), y[rows]);
		}
		...
		for (rows_trans = 0; rows_trans < vars_x; rows_trans++)
		{
			for (cols = 0; cols < obs_x; cols++)
			{
				printf("%lf ", transpose[cols][rows_trans]);
	 		}
			printf("\n ");
		}
		...
		printf( "The determinant is = %lf", d );
...
*******************************************************************************/
void cofact(double num[100][100], double f, double xy[100], int rows_trans, double obs_x, double x[100][100], double y[100])
{
...
*******************************************************************************/
void trans(double num[100][100], double fac[100][100], double r, double xy[100], int rows_trans, double obs_x, double x[100][100], double y[100])
...
*******************************************************************************/
double reg(double r, double xy[100], int rows_trans, double inv[100][100], double obs_x, double x[100][100], double y[100])
{
...
*******************************************************************************/
//u=y-XB // double xy[100]?, double inv[100][100],
void stderror(double r, double beta[100], double obs_x, double x[100][100], double y[100], double inv[100][100])
{
	int i, j = 0;
